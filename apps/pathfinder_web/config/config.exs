...
config :esbuild,
  version: "0.25.5",
  default: [
    args: ~w(css/app.css css/bootstrap.min.css static/images/icon.png js/app.jsx --bundle --target=es2017 --outdir=../priv/static/assets --loader:.css=copy --loader:.png=copy),
